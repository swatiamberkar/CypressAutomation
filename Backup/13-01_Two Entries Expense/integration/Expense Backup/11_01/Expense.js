...
class Expense {
	...
	verifyExpensedetailsAtManagerReport(employeeID, employeeName, currentDate, ClaimDate, ClaimType, ClaimAmount, FromDate, ToDate, filePath, Remark,
		...
		ApproveStatus, REJECTREMARK, managerID, managerName, manager1Remark, managerID2, managerName2, managerRemark2,
				...
				text.forEach(function (entry) {
					...
					cy.get('#EStableSorter>tbody>tr>:nth-child(14)').each(($el, index, $list) => {
						if ($el.text() == transcationID.trim()) {
							...
							obj => this.verifyManagerRemark1(managerLevel, managerID, managerName, manager1Remark, managerID2, managerName2, managerRemark2,
								managerID3, managerName3, managerRemark3)
							obj.

							cy.get('#EStableSorter> tbody > tr > :nth-child(16) > .btn').eq(index).click({ force: true });
							obj => this.verifyDetailsPopup1(employeeID, ClaimDate, ClaimType, ClaimAmount, FromDate, ToDate, Remark,
	...
	verifyExpensedetailsAtManagerReport1(employeeID, employeeName, currentDate, ClaimDate, ClaimType, ClaimAmount, FromDate, ToDate, filePath, Remark,
		FromLocation, ToLocation, Remark1, VendorName, InvoiceNumberId, Mode, Purpose, ApprovedAmountFromManager, ApprovedAmountFromFinance,
		...
		var indexValue =
			...
			this.verifyManagerRemark1(managerLevel, managerID, managerName, manager1Remark, managerID2, managerName2, managerRemark2,
				managerID3, managerName3, managerRemark3)

				this.verifyDetailsPopup1(employeeID, ClaimDate, ClaimType, ClaimAmount, FromDate, ToDate, Remark,
					VendorName, InvoiceNumberId, Mode, Purpose, ApprovedAmountFromManager, ApprovedAmountFromFinance, REJECTREMARK,
					financeRemark, financeStatus)
	...
	verifyManagerRemark1(managerLevel, managerID, managerName, manager1Remark, managerID2, managerName2, manager1Remark2,
		managerID3, managerName3, manager1Remark3) {
	...
	verifyExpenseDetailsAtHRReport(employeeID, employeeName, currentDate, ClaimDate, ClaimType, ClaimAmount, FromDate, ToDate, filePath, Remark,
		FromLocation, ToLocation, Remark1, VendorName, InvoiceNumberId, Mode, Purpose, ApprovedAmountFromManager, ApprovedAmountFromFinance, REJECTREMARK,
		managerID, managerName, manager1Remark, manager1Status, financeRemark, financeStatus,
		managerID2, managerName2, manager1Remark2, managerID3, managerName3, manager1Remark3, managerLevel) {
		const { softAssert, softExpect, softTrue } = chai;
		cy.visit(Cypress.env('essUrl') + 'Expense/Reports/HRReport?Menu=hrreport')
		cy.wait(2000)
		cy.get('#EStableSorter_length > label > .form-control').select('100')
	...
	verifyDetailsPopup1(employeeID, ClaimDate, ClaimType, ClaimAmount, FromDate, ToDate, Remark,
		VendorName, InvoiceNumberId, Mode, Purpose, ApprovedAmountFromManager, ApprovedAmountFromFinance, REJECTREMARK,
		financeRemark, financeStatus) {
		const { softAssert, softExpect, softTrue } = chai;
