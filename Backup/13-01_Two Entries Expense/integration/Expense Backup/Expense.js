...
class Expense {
	...
	VerifyDetailsAfterAddClaimEntry(ClaimDate, ClaimType, ClaimAmount, Remark,
		...
		cy.readFile('cypress/fixtures/Expense/Expense.json').then((text) => {
			text.forEach(function (entry) {
				...
				cy.log("TranscationID from JSON: "+transcationID)

				cy.get('#EStableSorter > tbody > tr> td:nth-child(5)').each(($el, index, $list) => {
					cy.get(' #EStableSorter > tbody > tr> td:nth-child(5)').eq(index).invoke('text').then((TranscationID) => {
						cy.log("TranscationID: "+TranscationID)
					})
				...
				cy.get('.table-responsive-vertical > #EStableSorter > tbody > tr > :nth-child(4)').invoke('text').then((text) => {
					...
					softExpect(parseInt(text)).to.eq(parseInt(Status));
				})
				...
				cy.get('#EStableSorter>tbody>tr>:nth-child(14)').each(($el, index, $list) => {
					if ($el.text() == transcationID.trim()) {
						...
						cy.get('#EStableSorter>tbody>tr> :nth-child(10)').eq(index).invoke('text').then((text) => {
							softExpect(parseInt(text.trim())).to.eq(ApprovedAmount);
						})
	...
	verifyExpenseDetailsAtFinanceReport(employeeID, employeeName, ClaimDate, ClaimType, ClaimAmount, FromDate, ToDate, filePath, Remark,
			...
			text.forEach(function (entry) {
				...
				cy.get('tbody > tr > :nth-child(13)').each(($el, index, $list) => {
					if ($el.text() == transcationID.trim()) {
						...
						cy.get('tbody > tr > :nth-child(6)').eq(index).should('contain.text', ClaimDate);
						cy.get('tbody > tr > :nth-child(7)').eq(index).should('contain.text', ClaimDate);
						cy.get('tbody > tr > :nth-child(8)').eq(index).should('contain.text', ClaimAmount);
						cy.get('tbody > tr > :nth-child(9)').eq(index).should('contain.text', ClaimAmount);
						cy.get('tbody > tr > :nth-child(10)').eq(index).should('contain.text', ClaimAmount);
						cy.get('tbody > tr > :nth-child(11)').eq(index).should('contain.text', ClaimDate);
	...
	verifyExpenseDetailsAtHRReport(transcationID, employeeID, employeeName, ClaimDate, ClaimType, ClaimAmount, FromDate, ToDate, filePath, Remark,
		FromLocation, ToLocation, Remark1, VendorName, InvoiceNumberId, Mode, Purpose, ApprovedAmount, FinanceAmount, FINANCEREMARK, REJECTREMARK, Status) {
		const { softAssert, softExpect, softTrue } = chai;
		...
		cy.readFile('cypress/fixtures/Expense/Expense.json').then((text) => {
			text.forEach(function (entry) {
				transcationID = entry.transcationID
				...
				cy.get('tbody > tr > :nth-child(14)').each(($el, index, $list) => {
					if ($el.text() == transcationID.trim()) {
						...
						cy.get('tbody > tr > :nth-child(9)').eq(index).should('contain.text', ClaimAmount);
						cy.get('tbody > tr > :nth-child(10)').eq(index).should('contain.text', ClaimAmount);
						//	cy.get('tbody > tr > :nth-child(11)').eq(index).should('contain.text',  Status);

						cy.get('tbody > tr > :nth-child(15) > .btn').eq(index).click();

						//this.VerifyDetailsPopup(transcationID, employeeID, employeeName, ClaimDate, ClaimType, ClaimAmount, FromDate, ToDate, filePath, Remark,
						//	FromLocation, ToLocation, Remark1, VendorName, InvoiceNumberId, Mode, Purpose, ApprovedAmount, FinanceAmount, FINANCEREMARK, REJECTREMARK, Status)
						...
						cy.get('.table-responsive-vertical > .table > tbody > :nth-child(2) > :nth-child(6)').should('have.text', ApprovedAmount);
						cy.get('.table-responsive-vertical > .table > tbody > :nth-child(2) > :nth-child(8)').should('have.text', ClaimAmount);
						...
						//cy.get('.table-responsive-vertical > .table > tbody > :nth-child(4) > :nth-child(6)').should('have.text', Status);
						...
						//cy.get('.table-responsive-vertical > .table > tbody > :nth-child(6) > :nth-child(2)').should('have.text', finance1Remark);
	...
	VerifyDetailsPopup(transcationID, employeeID, employeeName, ClaimDate, ClaimType, ClaimAmount, FromDate, ToDate, filePath, Remark,
		FromLocation, ToLocation, Remark1, VendorName, InvoiceNumberId, Mode, Purpose, ApprovedAmount, FinanceAmount, FINANCEREMARK, REJECTREMARK, Status) {
		...
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(2) > :nth-child(4)').should('have.text', ClaimAmount);
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(2) > :nth-child(6)').should('have.text', ApprovedAmount);
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(2) > :nth-child(8)').should('have.text', FinanceAmount);
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(3) > :nth-child(2)').should('have.text', FromDate);
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(3) > :nth-child(4)').should('have.text', ToDate);
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(3) > :nth-child(6)').should('have.text', Mode);
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(4) > :nth-child(2)').should('have.text', Purpose);
		...
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(5) > :nth-child(4)').should('have.text', VendorName);
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(5) > :nth-child(6)').should('have.text', InvoiceNumberId);
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(6) > :nth-child(2)').should('have.text', FINANCEREMARK);
		cy.get('.table-responsive-vertical > .table > tbody > :nth-child(6) > :nth-child(4)').should('have.text', REJECTREMARK);
