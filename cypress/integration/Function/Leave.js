...
class Leave {
	...
	verifyLeaveDetails(employeeID, EmployeeFirstName, EmployeeLastName, managerID,
		...
		cy.get('.form-horizontal > :nth-child(2) > :nth-child(1) > :nth-child(2)').invoke('text').then((Designation) => {
		...
		cy.get('.form-horizontal > :nth-child(2) > :nth-child(2) > :nth-child(2)').invoke('text').then((EmployeeJoiningDate) => {
		...
		cy.get('.form-horizontal > :nth-child(2) > :nth-child(3) > :nth-child(2)').invoke('text').then((LeaveTypeValue) => {
			softExpect(LeaveTypeValue.trim()).to.contains(leaveTypeValue)
		})

		cy.get('.form-horizontal > :nth-child(2) > :nth-child(3) > :nth-child(2)').invoke('text').then((Balance) => {
