...
describe('01_Approve_Manager1_Externally_Manager2_Externally_Finance_Externally', function () {
	...
	it('Approve Internally At Finance', function () {
		var financeRemark = 'Approve by Finance'
		//cy.EssLogin(financeID, financeID)
		expense.ApproveFromDetailAtFinance(financeRemark, ClaimAmount, ApprovedAmountFromFinance)
	})
