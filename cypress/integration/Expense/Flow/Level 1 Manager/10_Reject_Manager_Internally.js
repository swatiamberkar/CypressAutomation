...
describe('10_Reject_Manager_Internally', function () {
	...
	it('Reject Internally At Manager', function () {

		//cy.EssLogin(managerID, managerID)
		expense.RejectFromDetailAtManager(REJECTREMARK, ClaimAmount, ApprovedAmountFromManager)
	})
