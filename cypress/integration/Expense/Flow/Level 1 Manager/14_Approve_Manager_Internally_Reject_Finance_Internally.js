...
describe('14_Approve_Manager_Internally_Reject_Finance_Internally', function () {
	...
	let transcationID = ''
	var manager1Remark = 'Approve By Manager'
	var manager1Status = 'Approved'
	var financeRemark = 'Approved By Finance'
	...
	it('Reject Externally At Finance', function () {
		var financeRemark = 'Rejected'
		//cy.EssLogin(financeID, financeID)
	  expense.RejectFromDetailAtFinance(financeRemark, ClaimAmount, ApprovedAmountFromFinance)
  })
