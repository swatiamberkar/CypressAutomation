...
describe('08_Approve_Manager_Internally_ChangeApprovedAmount_Finance_Internally_ChangeApprovedAmount', function () {
	...
	it('Approve From Detail At Finance with Change Amount', function () {
		//cy.EssLogin(financeID, financeID)
