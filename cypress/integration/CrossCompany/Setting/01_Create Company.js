describe('01_Setting', function () {
   ...
   it('Add Company', function () {
        ...
        var companyText = Randomcomapnyname(3);
        var SelfservicecodeText = companycode(5);
        cy.writeFile('cypress/fixtures/CrossCompany.json', [{ "comapnayname": companyText, "comapnaycode": SelfservicecodeText }])
